...
Desc: A program that runs a "Spot the Difference" game using ASCII art. The user load a file using commands from the menu, and then can play the game.
...
bool loadFile(char charArr[ROWS][COLS]) {
/*
...
return: T/F for whether the file was loaded
*/    
}
